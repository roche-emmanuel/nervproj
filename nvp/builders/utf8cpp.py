"""This module provide the builder for the utf8cpp library."""
...
def register_builder(bman: BuildManager):
    ...
    bman.register_builder("utf8cpp", Builder(bman))


class Builder(NVPBuilder):
    """utf8cpp builder class."""
    ...
    def build_on_linux(self, build_dir, prefix, desc):
        ...
        # "-DBUILD_SHARED_LIBS=OFF", "-DFT_REQUIRE_ZLIB=TRUE"
        # if self.compiler.is_emcc():
