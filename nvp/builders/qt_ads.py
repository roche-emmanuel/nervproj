"""This module provide the builder for the QT ADS library."""
...
def register_builder(bman: BuildManager):
    ...
    bman.register_builder("QT_ADS", Builder(bman))


class Builder(NVPBuilder):
    """QT ADS builder class."""

    def build_on_windows(self, build_dir, prefix, _desc):
        """Build on windows method"""

        qt6_dir = self.man.get_library_root_dir("QT6").replace("\\", "/")
        ...
        flags = [
            ...
            f"-DQT_DIR={qt6_dir}/lib/cmake/Qt6/",
            f"-DQt6_DIR={qt6_dir}/lib/cmake/Qt6/",
    ...
    def build_on_linux(self, build_dir, prefix, desc):
        ...
        flags = [
            ...
            f"-DBZIP2_LIBRARY_RELEASE={bz2_dir}/lib/{bz2_lib}",
            f"-DBZIP2_INCLUDE_DIR={bz2_dir}/include",
            "-DBZIP2_FOUND=TRUE",
            f"-DZLIB_LIBRARY={zlib_dir}/lib/{z_lib}",
            f"-DZLIB_INCLUDE_DIR={zlib_dir}/include",
